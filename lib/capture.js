         ...
         for (var j=0; j<width; j++){
           ...
           for(var k=0; k<K; k++){
            //  dis[k] = dis_2(5,centers[k],xyrgb[i][j]);
             if(typeof(para.method) == "undefined"){
               dis[k] = dis_2(5,centers[k],xyrgb[i][j]);
             }else if(typeof(dis_methods[para.method]) == "undefined"){
               dis[k] = dis_2(5,centers[k],xyrgb[i][j]);
               console.log("Your method is not supported now. The following parts are allowed:");
               console.log(dis_methods);
             }else if(para.method == "Minkowski"){
               dis[k] = dis_methods[para.method](para.parameters[0], 5, centers[k],xyrgb[i][j]);
             }else{
               dis[k] = dis_methods[para.method](5,centers[k],xyrgb[i][j]);
             }
